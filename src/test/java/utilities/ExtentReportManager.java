...
public class ExtentReportManager implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
	    ...
	    // Get WebDriver from ITestContext
	    WebDriver driver = (WebDriver) result.getTestContext().getAttribute("driver");

	    if (driver != null) {
	        try {
	            // Create timestamped screenshot file path
	            ...
	            // Use reliable copy instead of renameTo
	        ...
	        test.log(Status.WARNING, "WebDriver is null - cannot capture screenshot.");
	    }
	}
	...
	public void onFinish(ITestContext testContext) {
		...
		try {
		  ...
		  try {
			  ...
			  email.setAuthenticator(new DefaultAuthenticator("sadiqmdsyed@gmail.com","password")); 
			  email.setSSLOnConnect(true);
			  email.setFrom("sadiqmdsyed@gmail.com"); //Sender
